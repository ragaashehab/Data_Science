# -*- coding: utf-8 -*-
"""
Created on Sat Jun 25 13:43:50 2022
...
def points():
    ...
    # YOUR CODE HERE
    olympic_df = DataFrame({"countries": Series(countries), "gold": Series(gold) , "silver": Series(silver), "bronze": Series(bronze)})
    olympic_prices_df= olympic_df[["gold","silver","bronze"]]
    points= numpy.dot(olympic_prices_df, [4,2,1])
